...
inline __host__ __device__ uint3 make_uint3(uint x, uint y){
    return make_uint3(x, y, 0u);
}
inline __host__ __device__ uint3 make_uint3(uint2 v){
    return make_uint3(v.x, v.y, 0u);
}
...
inline __host__ __device__ uint3 operator+(uint x, uint3 y){
    return make_uint3(x + y.x, x + y.y, x + y.z);
}
...
// inline __host__ __device__ bool operator<(uint3 x, uint3 y) {
...
inline  __host__ __device__ uint min(uint2 v){
    return min(v.x, v.y);
}
inline  __host__ __device__ uint min(uint3 v){
    return min(v.x, min(v.y, v.z));
}
inline  __host__ __device__ uint min(uint4 v){
...
inline  __host__ __device__ uint max(uint2 v){
    return max(v.x, v.y);
}
inline  __host__ __device__ uint max(uint3 v){
    return max(v.x, max(v.y, v.z));
}
inline  __host__ __device__ uint max(uint4 v){
...
inline __host__ __device__ uint prod(uint2 x){
    return x.x * x.y;
}
inline __host__ __device__ uint prod(uint3 x){
    return x.x * x.y * x.z;
}
inline __host__ __device__ uint prod(uint4 x){
    return x.x * x.y * x.z * x.w;
}
...
inline __host__ __device__ uint all(uint2 v){
    return v.x & v.y;
}
inline __host__ __device__ uint all(uint3 v){
    return v.x & v.y & v.z;
}
inline __host__ __device__ uint all(uint4 v){
...
inline __host__ __device__ uint any(uint2 v){
    return v.x | v.y;
}
inline __host__ __device__ uint any(uint3 v){
    return v.x | v.y | v.z;
}
inline __host__ __device__ uint any(uint4 v){
    return v.x | v.y | v.z | v.w;
}
