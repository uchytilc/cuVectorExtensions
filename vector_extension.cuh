...
#include "vector_extension_float.cuh"
#include "vector_extension_int.cuh"
#include "vector_extension_uint.cuh"
...
inline __host__ __device__ uint3 make_uint3(int x, int y){
    return make_uint3((uint)x, (uint)y, 0);
}
inline __host__ __device__ uint3 make_uint3(int2 v){
    return make_uint3((uint)v.x, (uint)v.y, 0);
}
